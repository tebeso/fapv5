...
window.FapMain = /*#__PURE__*/function () {
  ...
  _createClass(FapMain, [{
    ...
    value: function getNavigationItems(id) {
      var $this = this;
      $.ajax({
        type: 'GET',
    ...
    value: function changeSliderPosition(id) {
    ...
    value: function addNavigationItem(item) {
      var lastArrow = $('.fap-button-navigation-arrow').last();
      var element = $('<div class="fap-button fap-button-navigation fap-button-inactive"></div>');
      /**
