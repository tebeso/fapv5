@include('general.aircraft-audio')

<div style="position:absolute; top:0;">
    <div class="fap-content-box fap-box-small" style="top:165px; left:96px; height: 190px;">
...
<div class="fap-content-box fap-box-large" style="top:120px; left: 369px; display: flex;">
    ...
    <div style="width: 50%; height: 85%; padding-top: 20px;">
        ...
        <div style="top: 115px; left: 65px; position: relative;">
            ...
            <div class="fap-button-group" style="width: 170px;">
                ...
                <div class="fap-button fap-button-inactive fap-button-function" id="audio-storage-numpad-enter">Enter
                </div>
            </div>
        </div>
    </div>
