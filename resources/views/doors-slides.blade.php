...
@section('module')
    ...
    @elseif(\Illuminate\Support\Env::get('AIRCRAFT') === 'A346')
        ...
        <div class="open-doors">
            <div class="door door-generic door-open door-one-open door-left-open-front-aft"></div>
            <div class="door door-generic door-open door-two-open door-left-open"></div>
            <div class="door door-overwing door-open door-three-open door-left-open"></div>
            <div class="door door-generic door-open door-four-open door-left-open"></div>
            <div class="door door-generic door-open door-five-open door-left-open-front-aft"></div>
            <div class="door door-generic door-open door-one-open door-right-open-front-aft"></div>
            <div class="door door-generic door-open door-two-open door-right-open"></div>
            <div class="door door-overwing door-open door-three-open door-right-open"></div>
            <div class="door door-generic door-open door-four-open door-right-open"></div>
            <div class="door door-generic door-open door-five-open door-right-open-front-aft"></div>
        </div>
    @else
